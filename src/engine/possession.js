 ...
 * bindings for `LOCAL_SESSION` from snapshots (`src/client/net/snapshot-apply.js`).
 *
...
import { formatRuntimeId } from './actors/ids.js';
 ...
 * `src/client/net/snapshot-apply.js`).
 */
 ...
 * Used by the operator modal (`src/client/ui/door-operator.js`) and included in
