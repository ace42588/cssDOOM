 ...
 *     `src/client/renderer/dom/host.js` (via `createDomRendererHost()`).
 *   - The server (`server/world-host/hosts.js`) installs a recording host from
 *     `src/engine/ports/recording-renderer-host.js` that buffers each call as
