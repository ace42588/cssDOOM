 ...
 * `src/engine/ai/controller.js` and `src/engine/possession.js` and build their
...
import { hasPowerup } from '../things/pickups.js';
...
import { input } from '../ports/input.js';
...
import { canFire } from '../actors/capabilities.js';
