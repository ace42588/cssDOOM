/**
 * DOM renderer host — binds the facade in `src/engine/ports/renderer.js` to the
...
import { buildDoor, setDoorState } from '../scene/sector-mechanics/doors.js';
import { buildLift, setLiftState } from '../scene/sector-mechanics/lifts.js';
import { buildCrusher, setCrusherOffset } from '../scene/sector-mechanics/crushers.js';
import { toggleSwitchState } from '../scene/sector-mechanics/switches.js';
