...
import {
  ENEMY_THING_TYPES,
  PICKUP_THING_TYPES,
  SHOOTABLE_THING_TYPES,
  THING_HEALTH as SHARED_THING_HEALTH,
  SOLID_THING_RADIUS as SHARED_SOLID_THING_RADIUS,
} from "../data/things.js";
...
export const ENEMIES = new Set(ENEMY_THING_TYPES);
export const PICKUPS = new Set(PICKUP_THING_TYPES);
...
export const THING_HEALTH = SHARED_THING_HEALTH;

// Set of all thing types that can be damaged by the player's weapons.
export const SHOOTABLE = new Set(SHOOTABLE_THING_TYPES);
...
export const ENEMY_AI_STATS = {
  ...
  3004: {
    ...
    alertSound: "DSPOSIT1",
    pellets: 1,
    hitscanSound: "DSPISTOL",
    painChance: 200,
    reactionTime: 8 / 35,
    attackDuration: 0.457,
    painDuration: 0.171,
  }, // Zombieman (speed 8, 4-tic frames)
  9: {
    speed: 93,
    chaseTics: 3,
    radius: 20,
    ...
    alertSound: "DSPOSIT2",
    pellets: 3,
    hitscanSound: "DSSHOTGN",
    painChance: 170,
    reactionTime: 8 / 35,
    attackDuration: 0.457,
    painDuration: 0.171,
  }, // Shotgun Guy (speed 8, 3-tic frames)
  3001: {
    speed: 93,
    chaseTics: 3,
    radius: 20,
    ...
    attackDuration: 0.457,
    painDuration: 0.171,
  }, // Imp (speed 8, 3-tic frames) — melee: A_TroopAttack claw
  3002: {
    speed: 175,
    chaseTics: 2,
    radius: 30,
    ...
    painChance: 180,
    reactionTime: 8 / 35,
    attackDuration: 0.343,
    painDuration: 0.171,
  }, // Demon (speed 10, 2-tic frames) — melee only: A_SargAttack
  58: {
    speed: 175,
    chaseTics: 2,
    radius: 30,
    ...
    attackDuration: 0.343,
    painDuration: 0.171,
  }, // Spectre (speed 10, 2-tic frames) — melee only: A_SargAttack
  3003: {
    speed: 93,
    chaseTics: 3,
    radius: 24,
    ...
    painChance: 50,
    reactionTime: 8 / 35,
    attackDuration: 0.571,
    painDuration: 0.171,
  }, // Baron (speed 8, 3-tic frames) — melee: A_BruisAttack claw
};
...
export const ENEMY_PROJECTILES = {
  3001: {
    ...
    size: 15,
    missileDamage: 3,
  }, // Imp fireball: 10*FRACUNIT/tic × 35 = 350 units/s, 3–24 damage
  3003: {
    sprite: "BAL7A1A5",
    speed: 525,
    sound: "DSFIRSHT",
    ...
    size: 16,
    missileDamage: 8,
  }, // Baron fireball: 15*FRACUNIT/tic × 35 = 525 units/s, 8–64 damage
};
