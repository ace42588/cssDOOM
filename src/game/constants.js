...
export const ENEMY_AI_STATS = {
    ...
    3001: { speed: 93,  chaseTics: 3, attackRange: 1500, damage: 15, cooldown: 2.0, sightRange: 3000, melee: false, meleeRange: 64, alertSound: 'DSBGSIT1', painChance: 200, reactionTime: 8/35, attackDuration: 0.457, painDuration: 0.171 },  // Imp (speed 8, 3-tic frames) — melee: A_TroopAttack claw
    3002: { speed: 175, chaseTics: 2, attackRange: 64,   damage: 0,  cooldown: 1.0, sightRange: 3000, melee: true,  meleeRange: 64, alertSound: 'DSSGTSIT', painChance: 180, reactionTime: 8/35, attackDuration: 0.343, painDuration: 0.171 },  // Demon (speed 10, 2-tic frames) — melee only: A_SargAttack
    58:   { speed: 175, chaseTics: 2, attackRange: 64,   damage: 0,  cooldown: 1.0, sightRange: 3000, melee: true,  meleeRange: 64, alertSound: 'DSSGTSIT', painChance: 180, reactionTime: 8/35, attackDuration: 0.343, painDuration: 0.171 },  // Spectre (speed 10, 2-tic frames) — melee only: A_SargAttack
    3003: { speed: 93,  chaseTics: 3, attackRange: 1500, damage: 60, cooldown: 2.5, sightRange: 3000, melee: false, meleeRange: 64, alertSound: 'DSPOSIT3', painChance: 50,  reactionTime: 8/35, attackDuration: 0.571, painDuration: 0.171 },  // Baron (speed 8, 3-tic frames) — melee: A_BruisAttack claw
};
